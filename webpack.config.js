...
const urlProd = "https://cdn.ezeep.com/ezeep-msoffice-addin/"; // CHANGE THIS TO YOUR PRODUCTION DEPLOYMENT LOCATION
          ...
          },
          {
            ...
            transform(content) {
              if (dev) {
                ...
                return content.toString().replace(new RegExp(urlDev, "g"), urlProd + "v" + env.version + "/");
              }
            },
          },
        ],
